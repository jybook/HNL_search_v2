...
executable = '/data/user/lfischer/hnl_analysis/reconstruction/taupede.py'
dagman_location = '/scratch/lfischer/taupede/dagman'
output_base = '/data/ana/SterileNeutrino/IC86/HighEnergy/HNL/MC/oscNext'
...
for mc_set_name, mc_set_numbers in mc_sets.iteritems():
    for mc_set_number in mc_set_numbers:
        ...
        output_files_location = os.path.join(output_files_location, 'taupede')
        ...
        submission_script_name = 'dagman_submit_oscnext_{}_{}.sub'.format(mc_set_name, mc_set_number)
        ...
        submission_script.write('# dagman submit taupede reco for all {} {} files in one go'.format(mc_set_name, mc_set_number))
        ...
        submission_script.write('\n')
        submission_script.write('\n')
        submission_script.write('log = /scratch/lfischer/condor_logs/taupede/oscnext_{}_{}.log'.format(mc_set_name, mc_set_number))
        submission_script.write('\n')
        submission_script.write('output = /scratch/lfischer/condor_output/taupede/oscnext_{}_{}.out'.format(mc_set_name, mc_set_number))
        submission_script.write('\n')
        submission_script.write('error = /scratch/lfischer/condor_error/taupede/{}/$(Cluster)_$(Process).err'.format(mc_set_number))
        submission_script.write('\n')
        submission_script.write('\n')
        ...
        # write job script
        job_script_name = 'dagman_job_oscnext_{}_{}.dag'.format(mc_set_name, mc_set_number)
